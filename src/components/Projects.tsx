  ...
  const projects = [
    {
      ...
      description: 'A comprehensive quantitative trading platform built with Python and machine learning algorithms for automated trading strategies.',
      tech: ['Python', 'TensorFlow', 'Pandas', 'PostgreSQL'],
      github: '#',
      demo: '#',
      image: '🔢',
